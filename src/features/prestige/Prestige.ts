...
export class Prestige extends Feature {
    ...
    initialize(): void {
        ...
        this.addPrestigeUpgrade("development-reduce-target-movement-2", MiniGameUpgradeType.BalancingTargetMovement, "Reduce target movement by 30%", 50, 0.7, ['development-minigame-upgrade-cost-1']);
        this.addPrestigeUpgrade("development-reduce-target-movement-3", MiniGameUpgradeType.BalancingTargetMovement, "Remove target movement", 800, 0, ['development-reduce-target-movement-2']);
        ...
        this.addPrestigeUpgrade("development-movement-speed-2", MiniGameUpgradeType.BalancingMovementSpeed, "Improve movement speed by 20%", 25, 1.20, ['development-focus-gain-1']);
        this.addPrestigeUpgrade("development-focus-gain-2", MiniGameUpgradeType.BalancingFocusGain, "Improve focus gain by 50%", 50, 1.50, ['development-movement-speed-2']);
