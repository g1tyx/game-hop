...
export class Prestige extends Feature {
    ...
    initialize(): void {
        ...
        this.addPrestigeUpgrade("development-reduce-target-movement-3", MiniGameUpgradeType.BalancingTargetMovement, "Remove target movement", 800, 0, ['development-movement-speed-2']);
