...
export class Prestige extends Feature {
    ...
    initialize(): void {
        ...
        this.addPrestigeUpgrade("global-yearly-requirements", MiniGameUpgradeType.MiniGameYearlyRequirements, "Reduce all Yearly Requirements by 10%", 200, 0.9, ['design-value-1', 'development-focus-gain-1']);
        ...
        // Marketing
        this.addPrestigeUpgrade("marketing-fame-1", MiniGameUpgradeType.MarketingFame, "Increase marketing Fame by 20%", 20, 1.20, ['global-unlock-minigame-upgrades']);
        ...
        // Design
        this.addPrestigeUpgrade("design-value-1", MiniGameUpgradeType.DesignShapeValue, "Increase design value by 20%", 20, 1.20, ['global-unlock-minigame-upgrades']);
        ...
        // Debugging
        this.addPrestigeUpgrade("debugging-reduce-movement-cost-1", MiniGameUpgradeType.BugFixingMoveCost, "Reduce movement cost by 20%", 20, 0.80, ['global-unlock-minigame-upgrades']);
        ...
        this.addPrestigeUpgrade("debugging-reduce-yearly-requirements", MiniGameUpgradeType.MiniGameYearlyRequirements, "Reduce all Yearly Requirements by 20%", 50, 0.80, ['debugging-improve-value-2']);

        // Development
        this.addPrestigeUpgrade("development-focus-gain-1", MiniGameUpgradeType.BalancingFocusGain, "Improve focus gain by 20%", 20, 1.20, ['global-unlock-minigame-upgrades']);
